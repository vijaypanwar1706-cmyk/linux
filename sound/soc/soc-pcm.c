...
static inline int
_soc_pcm_ret (struct snd_soc_pcm_runtime *rtd, const char *func, int ret)
{
...
#if 0
static int
snd_soc_dpcm_fe_can_update (struct snd_soc_pcm_runtime *fe, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_soc_dpcm_be_can_update (struct snd_soc_pcm_runtime *fe,
...
static int
snd_soc_dpcm_check_state (struct snd_soc_pcm_runtime *fe,
 ...
 */
static int
snd_soc_dpcm_can_be_free_stop (struct snd_soc_pcm_runtime *fe,
                               struct snd_soc_pcm_runtime *be, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    ...
    return snd_soc_dpcm_check_state (fe, be, stream, state,
                                     ARRAY_SIZE (state));
}
 ...
 */
static int
snd_soc_dpcm_can_be_params (struct snd_soc_pcm_runtime *fe,
                            struct snd_soc_pcm_runtime *be, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_soc_dpcm_can_be_prepared (struct snd_soc_pcm_runtime *fe,
                              struct snd_soc_pcm_runtime *be, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
soc_cpu_dai_name (struct snd_soc_pcm_runtime *rtd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    return (rtd)->dai_link->num_cpus == 1 ? snd_soc_rtd_to_cpu (rtd,
                                                                0)->
        name : "multicpu";
}

static inline const char *
soc_codec_dai_name (struct snd_soc_pcm_runtime *rtd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    return (rtd)->dai_link->num_codecs == 1 ? snd_soc_rtd_to_codec (rtd,
                                                                    0)->
        name : "multicodec";
}
...
static const char *
dpcm_state_string (enum snd_soc_dpcm_state state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    switch (state) {
...
static ssize_t
dpcm_show_state (struct snd_soc_pcm_runtime *fe,
...
static ssize_t
dpcm_state_read_file (struct file *file, char __user * user_buf,
                      size_t count, loff_t * ppos)
{
    ...
    if (fe->dai_link->num_cpus > 1) {
        dev_err (fe->dev, "%s doesn't support Multi CPU yet\n", __func__);
        return -EINVAL;
    }
...
void
soc_dpcm_debugfs_add (struct snd_soc_pcm_runtime *rtd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
dpcm_create_debugfs_state (struct snd_soc_dpcm *dpcm, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    char *name;
    ...
    if (name) {
        dpcm->debugfs_state =
            debugfs_create_dir (name, dpcm->fe->debugfs_dpcm_root);
...
static void
dpcm_remove_debugfs_state (struct snd_soc_dpcm *dpcm)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int dpcm_fe_dai_do_trigger (struct snd_pcm_substream *substream,
                                   int cmd);
static void
dpcm_set_fe_update_state (struct snd_soc_pcm_runtime *fe,
...
static void
dpcm_set_be_update_state (struct snd_soc_pcm_runtime *be,
                          int stream, enum snd_soc_dpcm_update state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
void
snd_soc_runtime_action (struct snd_soc_pcm_runtime *rtd,
 ...
 */
bool
snd_soc_runtime_ignore_pmdown_time (struct snd_soc_pcm_runtime *rtd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_component *component;
 ...
 */
int
snd_soc_set_runtime_hwparams (struct snd_pcm_substream *substream,
...
int
dpcm_dapm_stream_event (struct snd_soc_pcm_runtime *fe, int dir, int event)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_dpcm *dpcm;
...
static int
soc_pcm_apply_symmetry (struct snd_pcm_substream *substream,
...
static int
soc_pcm_params_symmetry (struct snd_pcm_substream *substream,
                         struct snd_pcm_hw_params *params)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
soc_pcm_update_symmetry (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd (substream);
    ...
    symmetry = link->symmetric_rate ||
        link->symmetric_channels || link->symmetric_sample_bits;

    for_each_rtd_dais (rtd, i, dai)
        symmetry = symmetry ||
        dai->driver->symmetric_rate ||
        dai->driver->symmetric_channels || dai->driver->symmetric_sample_bits;
...
static void
soc_pcm_set_msb (struct snd_pcm_substream *substream, int bits)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd (substream);
...
static void
soc_pcm_apply_msb (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd (substream);
    ...
    for_each_rtd_codec_dais (rtd, i, codec_dai) {
        const struct snd_soc_pcm_stream *pcm_codec =
            snd_soc_dai_get_pcm_stream (codec_dai, stream);
    ...
    for_each_rtd_cpu_dais (rtd, i, cpu_dai) {
        const struct snd_soc_pcm_stream *pcm_cpu =
            snd_soc_dai_get_pcm_stream (cpu_dai, stream);
...
static void
soc_pcm_hw_init (struct snd_pcm_hardware *hw)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    hw->rates = UINT_MAX;
...
static void
soc_pcm_hw_update_rate (struct snd_pcm_hardware *hw,
...
static void
soc_pcm_hw_update_chan (struct snd_pcm_hardware *hw,
                        const struct snd_soc_pcm_stream *p)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
soc_pcm_hw_update_format (struct snd_pcm_hardware *hw,
                          const struct snd_soc_pcm_stream *p)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
soc_pcm_hw_update_subformat (struct snd_pcm_hardware *hw,
                             const struct snd_soc_pcm_stream *p)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
int
snd_soc_runtime_calc_hw (struct snd_soc_pcm_runtime *rtd,
...
static void
soc_pcm_init_runtime_hw (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
soc_pcm_components_open (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd (substream);
...
static int
soc_pcm_components_close (struct snd_pcm_substream *substream, int rollback)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd (substream);
    ...
    for_each_rtd_components (rtd, i, component) {
        ...
        snd_soc_component_module_put_when_close (component, substream,
                                                 rollback);
    }
...
static int
soc_pcm_clean (struct snd_soc_pcm_runtime *rtd,
 ...
 */
static int
__soc_pcm_close (struct snd_soc_pcm_runtime *rtd,
                 struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
soc_pcm_close (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd (substream);
...
static int
soc_hw_sanity_check (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd (substream);
 ...
 */
static int
__soc_pcm_open (struct snd_soc_pcm_runtime *rtd,
                struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
__soc_pcm_prepare (struct snd_soc_pcm_runtime *rtd,
                   struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    ...
    if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK && rtd->pop_wait) {
        rtd->pop_wait = 0;
...
static int
soc_pcm_prepare (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd (substream);
...
static void
soc_pcm_codec_params_fixup (struct snd_pcm_hw_params *params,
                            unsigned int mask)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
soc_pcm_hw_clean (struct snd_soc_pcm_runtime *rtd,
                  struct snd_pcm_substream *substream, int rollback)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
__soc_pcm_hw_free (struct snd_soc_pcm_runtime *rtd,
                   struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
soc_pcm_hw_free (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd (substream);
 ...
 */
static int
__soc_pcm_hw_params (struct snd_soc_pcm_runtime *rtd,
                     struct snd_pcm_substream *substream,
                     struct snd_pcm_hw_params *params)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
...
static int
soc_pcm_hw_params (struct snd_pcm_substream *substream,
                   struct snd_pcm_hw_params *params)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int (*const trigger[][TRIGGER_MAX]) (struct snd_pcm_substream *
                                            substream, int cmd,
                                            int rollback) = {
...
static int
soc_pcm_trigger (struct snd_pcm_substream *substream, int cmd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd = snd_soc_substream_to_rtd (substream);
...
/* connect a FE and BE */
static int
dpcm_be_connect (struct snd_soc_pcm_runtime *fe,
                 struct snd_soc_pcm_runtime *be, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
dpcm_be_reparent (struct snd_soc_pcm_runtime *fe,
                  struct snd_soc_pcm_runtime *be, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
dpcm_be_disconnect (struct snd_soc_pcm_runtime *fe, int stream)
{
    ...
    for_each_dpcm_be_safe (fe, stream, dpcm, d) {
        dev_dbg (fe->dev, "ASoC: BE %s disconnect check for %s\n",
                 snd_pcm_direction_name (stream), dpcm->be->dai_link->name);
...
int
widget_in_list (struct snd_soc_dapm_widget_list *list,
...
bool
dpcm_end_walk_at_be (struct snd_soc_dapm_widget *widget,
...
int
dpcm_path_get (struct snd_soc_pcm_runtime *fe,
...
void
dpcm_path_put (struct snd_soc_dapm_widget_list **list)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static bool
dpcm_be_is_active (struct snd_soc_dpcm *dpcm, int stream,
                   struct snd_soc_dapm_widget_list *list)
{
    ...
    for_each_rtd_dais (dpcm->be, i, dai) {
        struct snd_soc_dapm_widget *widget =
            snd_soc_dai_get_widget (dai, stream);
...
static int
dpcm_prune_paths (struct snd_soc_pcm_runtime *fe, int stream,
...
static int
dpcm_add_paths (struct snd_soc_pcm_runtime *fe, int stream,
                struct snd_soc_dapm_widget_list **list_)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
int
dpcm_process_paths (struct snd_soc_pcm_runtime *fe,
                    int stream, struct snd_soc_dapm_widget_list **list,
                    int new)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
...
void
dpcm_clear_pending_state (struct snd_soc_pcm_runtime *fe, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_dpcm *dpcm;
...
void
dpcm_be_dai_stop (struct snd_soc_pcm_runtime *fe, int stream,
    ...
    for_each_dpcm_be (fe, stream, dpcm) {
        ...
        if (be->dpcm[stream].users == 0) {
            dev_err (be->dev, "ASoC: no users %s at close - state %d\n",
                     snd_pcm_direction_name (stream), be->dpcm[stream].state);
            continue;
        }
...
int
dpcm_be_dai_startup (struct snd_soc_pcm_runtime *fe, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_substream *fe_substream =
...
static void
dpcm_runtime_setup_fe (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
dpcm_runtime_setup_be_format (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd (substream);
...
static void
dpcm_runtime_setup_be_chan (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd (substream);
    ...
    ; /* avoid -Wswitch-unreachable */
        ...
        if (be->dai_link->num_codecs == 1) {
            const struct snd_soc_pcm_stream *codec_stream =
                snd_soc_dai_get_pcm_stream (snd_soc_rtd_to_codec (be, 0),
                                            stream);
...
static void
dpcm_runtime_setup_be_rate (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd (substream);
...
static int
dpcm_apply_symmetry (struct snd_pcm_substream *fe_substream, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_dpcm *dpcm;
...
static int
dpcm_fe_dai_startup (struct snd_pcm_substream *fe_substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd (fe_substream);
...
void
dpcm_be_dai_hw_free (struct snd_soc_pcm_runtime *fe, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_dpcm *dpcm;
...
static int
dpcm_fe_dai_hw_free (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd (substream);
...
int
dpcm_be_dai_hw_params (struct snd_soc_pcm_runtime *fe, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *be;
...
int
dpcm_be_dai_trigger (struct snd_soc_pcm_runtime *fe, int stream, int cmd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *be;
    ...
    ; /* avoid -Wswitch-unreachable */
        case SNDRV_PCM_TRIGGER_START:
            ...
            if (be->dpcm[stream].state == SND_SOC_DPCM_STATE_PAUSED)
                ...
                ret = soc_pcm_trigger (be_substream, SNDRV_PCM_TRIGGER_START);
            if (ret) {
                be->dpcm[stream].be_start--;
                goto next;
            }
...
static int
dpcm_dai_trigger_fe_be (struct snd_pcm_substream *substream,
...
static int
dpcm_fe_dai_do_trigger (struct snd_pcm_substream *substream, int cmd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd (substream);
...
int
dpcm_be_dai_prepare (struct snd_soc_pcm_runtime *fe, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_dpcm *dpcm;
...
static int
dpcm_fe_dai_prepare (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd (substream);
...
static int
dpcm_run_update_shutdown (struct snd_soc_pcm_runtime *fe, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    int err;
...
static int
soc_dpcm_fe_runtime_update (struct snd_soc_pcm_runtime *fe, int new)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_dapm_widget_list *list;
 ...
 */
int
snd_soc_dpcm_runtime_update (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
dpcm_fe_dai_cleanup (struct snd_pcm_substream *fe_substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd (fe_substream);
...
static int
dpcm_fe_dai_close (struct snd_pcm_substream *fe_substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd (fe_substream);
...
static int
dpcm_fe_dai_open (struct snd_pcm_substream *fe_substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *fe = snd_soc_substream_to_rtd (fe_substream);
                          ...
                          int *playback, int *capture)
{
    ...
    ; /* avoid -Wswitch-unreachable */
            ...
            if (!dai_link->dpcm_playback &&
                dai_link->dpcm_capture && !dai_link->capture_only) {
                dev_warn (rtd->card->dev,
                          "both playback/capture are available,"
        ...
        int cpu_playback =
            snd_soc_get_stream_cpu (dai_link, SNDRV_PCM_STREAM_PLAYBACK);
        ...
        for_each_rtd_ch_maps (rtd, i, ch_maps) {
            ...
            if (snd_soc_dai_stream_valid
                (codec_dai, SNDRV_PCM_STREAM_PLAYBACK)
...
static int
soc_create_pcm (struct snd_pcm **pcm,
                struct snd_soc_pcm_runtime *rtd,
...
/* create a new pcm */
int
soc_new_pcm (struct snd_soc_pcm_runtime *rtd, int num)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_component *component;
    ...
    ; /* avoid -Wswitch-unreachable */
        if (playback)
            pcm->streams[SNDRV_PCM_STREAM_PLAYBACK].substream->private_data =
                rtd;
        if (capture)
            pcm->streams[SNDRV_PCM_STREAM_CAPTURE].substream->private_data =
                rtd;
        goto out;
    }
