...
static ssize_t
pmdown_time_show (struct device *dev,
...
static ssize_t
pmdown_time_store (struct device *dev,
...
static umode_t
soc_dev_attr_is_visible (struct kobject *kobj,
...
static int
dai_list_show (struct seq_file *m, void *v)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
component_list_show (struct seq_file *m, void *v)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_component *component;
...
static void
soc_cleanup_card_debugfs (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_soc_is_match_dai_args (const struct of_phandle_args *args1,
...
static int
snd_soc_is_matching_dai (const struct snd_soc_dai_link_component *dlc,
                         struct snd_soc_dai *dai)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
const char *
snd_soc_dai_name_get (const struct snd_soc_dai *dai)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_soc_rtd_add_component (struct snd_soc_pcm_runtime *rtd,
                           struct snd_soc_component *component)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
struct snd_soc_component *
snd_soc_lookup_component (struct device *dev, const char *driver_name)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_component *component;
 ...
 */
void
snd_soc_close_delayed_work (struct snd_soc_pcm_runtime *rtd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    ...
    dev_dbg (rtd->dev,
             ...
             "active" : "inactive", rtd->pop_wait ? "yes" : "no");
...
static void
soc_release_rtd_dev (struct device *dev)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    /* "dev" means "rtd->dev" */
...
static void
soc_free_pcm_runtime (struct snd_soc_pcm_runtime *rtd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    if (!rtd)
...
static void
close_delayed_work (struct work_struct *work)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd =
                     ...
                     struct snd_soc_dai_link *dai_link)
{
    ...
    rtd = devm_kzalloc (dev,
                        struct_size (rtd, components,
                                     dai_link->num_cpus +
                                     dai_link->num_codecs +
                                     dai_link->num_platforms), GFP_KERNEL);
    if (!rtd) {
...
static void
snd_soc_fill_dummy_dai (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_dai_link *dai_link;
...
static void
snd_soc_flush_all_delayed_work (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd;
...
static void
soc_playback_digital_mute (struct snd_soc_card *card, int mute)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd;
...
static void
soc_dapm_suspend_resume (struct snd_soc_card *card, int event)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd;
...
int
snd_soc_suspend (struct device *dev)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static void
soc_resume_deferred (struct work_struct *work)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
int
snd_soc_resume (struct device *dev)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_card *card = dev_get_drvdata (dev);
...
static void
soc_resume_init (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
soc_dai_link_sanity_check (struct snd_soc_card *card,
 ...
 */
void
snd_soc_remove_pcm_runtime (struct snd_soc_card *card,
                            struct snd_soc_pcm_runtime *rtd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_soc_add_pcm_runtime (struct snd_soc_card *card,
                         struct snd_soc_dai_link *dai_link)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    ...
    ; /* avoid -Wswitch-unreachable */
        ...
        snd_soc_rtd_add_component (rtd,
                                   snd_soc_rtd_to_cpu (rtd, i)->component);
    }
    ...
    for_each_link_codecs (dai_link, i, codec) {
        ...
        snd_soc_rtd_add_component (rtd,
                                   snd_soc_rtd_to_codec (rtd, i)->component);
    }
...
int
snd_soc_add_pcm_runtimes (struct snd_soc_card *card,
                          struct snd_soc_dai_link *dai_link, int num_dai_link)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
snd_soc_runtime_get_dai_fmt (struct snd_soc_pcm_runtime *rtd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
  ...
  found:
    ...
    for (i = 63; i >= 0; i--) {
        ...
        case SND_SOC_POSSIBLE_DAIFMT_CONT:
            dai_fmt =
                (dai_fmt & ~SND_SOC_DAIFMT_CLOCK_MASK) | SND_SOC_DAIFMT_CONT;
            break;
        case SND_SOC_POSSIBLE_DAIFMT_GATED:
            dai_fmt =
                (dai_fmt & ~SND_SOC_DAIFMT_CLOCK_MASK) | SND_SOC_DAIFMT_GATED;
            break;
            /*
             * for clock invert
             */
...
static int
soc_init_pcm_runtime (struct snd_soc_card *card,
                      struct snd_soc_pcm_runtime *rtd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
soc_set_name_prefix (struct snd_soc_card *card,
                     struct snd_soc_component *component)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
soc_remove_component (struct snd_soc_component *component, int probed)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
soc_probe_component (struct snd_soc_card *card,
                     struct snd_soc_component *component)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
soc_remove_link_dais (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd;
...
static int
soc_probe_link_dais (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd;
...
static void
soc_remove_link_components (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_component *component;
...
static void
soc_unbind_aux_dev (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
soc_bind_aux_dev (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_component *component;
...
static int
soc_probe_aux_devices (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_component *component;
...
static void
soc_remove_aux_devices (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static void
append_dmi_string (struct snd_soc_card *card, const char *str)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
int
snd_soc_set_dmi_name (struct snd_soc_card *card, const char *flavour)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
soc_check_tplg_fes (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_component *component;
    ...
    for_each_component (component) {
        ...
        if (!strcmp (component->driver->ignore_machine,
            ...
            goto match;
        if (strcmp (component->driver->ignore_machine, dev_name (card->dev)))
            continue;
      match:
    ...
    ; /* avoid -Wswitch-unreachable */
            ...
            if (!card->topology_shortname_created) {
                ...
                snprintf (card->topology_shortname, 32, "%s-%s",
                          comp_drv->topology_name_prefix, card->name);
...
static void
__soc_setup_card_name (struct snd_soc_card *card,
                       char *name, int len,
...
static void
snd_soc_unbind_card (struct snd_soc_card *card, bool unregister)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    if (snd_soc_card_is_instantiated (card)) {
...
static int
snd_soc_bind_card (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_pcm_runtime *rtd;
...
int
snd_soc_poweroff (struct device *dev)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_card *card = dev_get_drvdata (dev);
 ...
 */
struct snd_kcontrol *
snd_soc_cnew (const struct snd_kcontrol_new *_template,
              void *data, const char *long_name, const char *prefix)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_soc_add_controls (struct snd_card *card, struct device *dev,
 ...
 */
int
snd_soc_add_card_controls (struct snd_soc_card *soc_card,
                           const struct snd_kcontrol_new *controls,
                           int num_controls)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
 ...
 */
void
snd_soc_unregister_card (struct snd_soc_card *card)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    mutex_lock (&client_mutex);
 ...
 */
static char *
fmt_single_name (struct device *dev, int *id)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    ...
    if (found) {
        ...
        *id = ((id1 & 0xffff) << 16) + id2;
        ...
        name =
            devm_kasprintf (dev, GFP_KERNEL, "%s.%s", dev->driver->name,
                            devname);
    }
    else {
        *id = 0;
 ...
 */
static inline char *
fmt_multiple_name (struct device *dev, struct snd_soc_dai_driver *dai_drv)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
struct snd_soc_dai *
snd_soc_register_dai (struct snd_soc_component *component,
 ...
 */
static void
snd_soc_unregister_dais (struct snd_soc_component *component)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_soc_register_dais (struct snd_soc_component *component,
 ...
 */
static void
convert_endianness_formats (struct snd_soc_pcm_stream *stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    int i;
...
static void
snd_soc_del_component_unlocked (struct snd_soc_component *component)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
int
snd_soc_component_initialize (struct snd_soc_component *component,
...
int
snd_soc_add_component (struct snd_soc_component *component,
 ...
 */
void
snd_soc_unregister_component_by_driver (struct device *dev,
                                        const struct snd_soc_component_driver
                                        *component_driver)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
 ...
 */
void
snd_soc_unregister_component (struct device *dev)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    mutex_lock (&client_mutex);
...
int
snd_soc_of_parse_card_name (struct snd_soc_card *card, const char *propname)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
int
snd_soc_of_parse_audio_simple_widgets (struct snd_soc_card *card,
                                       const char *propname)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
int
snd_soc_of_parse_pin_switches (struct snd_soc_card *card, const char *prop)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
int
snd_soc_of_get_slot_mask (struct device_node *np,
                          const char *prop_name, unsigned int *mask)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    u32 val;
...
int
snd_soc_of_parse_tdm_slot (struct device_node *np,
...
void
snd_soc_dlc_use_cpu_as_platform (struct snd_soc_dai_link_component *platforms,
...
void
snd_soc_of_parse_node_prefix (struct device_node *np,
...
int
snd_soc_of_parse_audio_routing (struct snd_soc_card *card,
                                const char *propname)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
int
snd_soc_of_parse_aux_devs (struct snd_soc_card *card, const char *propname)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
unsigned int
snd_soc_daifmt_clock_provider_flipped (unsigned int dai_fmt)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
unsigned int
snd_soc_daifmt_clock_provider_from_bitmap (unsigned int bit_frame)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    /*
...
unsigned int
snd_soc_daifmt_parse_format (struct device_node *np, const char *prefix)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    int ret;
...
unsigned int
snd_soc_daifmt_parse_clock_provider_raw (struct device_node *np,
                                         const char *prefix,
...
int
snd_soc_get_stream_cpu (const struct snd_soc_dai_link *dai_link, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    /*
...
int
snd_soc_get_dai_id (struct device_node *ep)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_component *component;
...
int
snd_soc_of_get_dlc (struct device_node *of_node,
...
int
snd_soc_get_dai_name (const struct of_phandle_args *args,
                      const char **dai_name)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
int
snd_soc_of_get_dai_name (struct device_node *of_node,
...
static int
__snd_soc_of_get_dai_link_component_alloc (struct device *dev,
                                           struct device_node *of_node,
                                           struct snd_soc_dai_link_component
                                           **ret_component, int *ret_num)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    ...
    num =
        of_count_phandle_with_args (of_node, "sound-dai", "#sound-dai-cells");
    if (num <= 0) {
        if (num == -ENOENT)
 ...
 */
void
snd_soc_of_put_dai_link_codecs (struct snd_soc_dai_link *dai_link)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_dai_link_component *component;
 ...
 */
int
snd_soc_of_get_dai_link_codecs (struct device *dev,
                                struct device_node *of_node,
                                struct snd_soc_dai_link *dai_link)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
 ...
 */
void
snd_soc_of_put_dai_link_cpus (struct snd_soc_dai_link *dai_link)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_soc_dai_link_component *component;
 ...
 */
int
snd_soc_of_get_dai_link_cpus (struct device *dev,
                              struct device_node *of_node,
                              struct snd_soc_dai_link *dai_link)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
