...
static int wm8960_set_dai_fmt(struct snd_soc_dai *codec_dai,
		unsigned int fmt)
{
	pr_info("WM8960_TRACE: wm8960_set_dai_fmt called: fmt=0x%x\n", fmt);
...
{
	pr_info("WM8960_TRACE: wm8960_configure_sysclk called: mclk=%d\n", mclk);
...
int wm8960_configure_pll(struct snd_soc_component *component, int freq_in,
			 int *sysclk_idx, int *dac_idx, int *bclk_idx)
{
	pr_info("WM8960_TRACE: wm8960_configure_pll called: freq_in=%d\n", freq_in);
...
{
	pr_info("WM8960_TRACE: wm8960_configure_clocking called\n");
			    ...
			    struct snd_soc_dai *dai)
{
	...
	printk(KERN_ERR "WM8960: hw_params called: rate=%d, format=%x\n",
           params_rate(params), params_format(params));
  	pr_info("WM8960_TRACE: wm8960_hw_params called: rate=%u format=0x%x\n",
        params_rate(params), params_format(params));
...
static int wm8960_mute(struct snd_soc_dai *dai, int mute, int direction)
{
	...
	pr_info("WM8960_TRACE: wm8960_hw_free called\n");
...
static int wm8960_set_pll(struct snd_soc_component *component,
		unsigned int freq_in, unsigned int freq_out)
{
	pr_info("WM8960_TRACE: wm8960_set_pll called: freq_in=%d freq_out=%d\n",
        freq_in, freq_out);
...
{
	pr_info("WM8960_TRACE: wm8960_set_dai_pll called: pll_id=%d freq_in=%d freq_out=%d\n",
...
static int wm8960_set_dai_clkdiv(struct snd_soc_dai *codec_dai,
		int div_id, int div)
{
	pr_info("WM8960_TRACE: wm8960_set_dai_clkdiv called: div_id=%d div=%d\n",
        div_id, div);
...
{
  	pr_info("WM8960_TRACE: wm8960_set_dai_sysclk called: clk_id=%d freq=%u\n",
        clk_id, freq);
