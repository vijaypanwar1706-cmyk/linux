 ...
 */
void
snd_pcm_stream_lock (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
void
snd_pcm_stream_unlock (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
void
snd_pcm_stream_lock_irq (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
void
snd_pcm_stream_unlock_irq (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
unsigned long
_snd_pcm_stream_lock_irqsave (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
void
snd_pcm_stream_unlock_irqrestore (struct snd_pcm_substream *substream,
                                  unsigned long flags)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
/* Run PCM ioctl ops */
static int
snd_pcm_ops_ioctl (struct snd_pcm_substream *substream,
...
int
snd_pcm_info (struct snd_pcm_substream *substream, struct snd_pcm_info *info)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
int
snd_pcm_info_user (struct snd_pcm_substream *substream,
...
static bool
hw_support_mmap (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
constrain_mask_params (struct snd_pcm_substream *substream,
...
static int
constrain_interval_params (struct snd_pcm_substream *substream,
                           struct snd_pcm_hw_params *params)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
fixup_unreferenced_params (struct snd_pcm_substream *substream,
                           struct snd_pcm_hw_params *params)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
int
snd_pcm_hw_refine (struct snd_pcm_substream *substream,
                   struct snd_pcm_hw_params *params)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_hw_refine_user (struct snd_pcm_substream *substream,
...
static int
period_to_usecs (struct snd_pcm_runtime *runtime)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    int usecs;
...
static void
snd_pcm_set_state (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static inline void
snd_pcm_timer_notify (struct snd_pcm_substream *substream, int event)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
void
snd_pcm_sync_stop (struct snd_pcm_substream *substream, bool sync_irq)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_pcm_hw_params_choose (struct snd_pcm_substream *pcm,
                          struct snd_pcm_hw_params *params)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_pcm_buffer_access_lock (struct snd_pcm_runtime *runtime)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
snd_pcm_buffer_access_unlock (struct snd_pcm_runtime *runtime)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
void
snd_pcm_runtime_buffer_set_silence (struct snd_pcm_runtime *runtime)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
                        ...
                        struct snd_pcm_hw_params __user * _params)
{
    ...
    if (IS_ERR (params))
        return PTR_ERR (params);
/* ✅ Now you can print rate, channels safely */
    printk(KERN_INFO "snd_pcm_hw_params_user(): hw_params received from user-space\n");
...
static int
do_hw_free (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    int result = 0;
...
int
snd_pcm_status64 (struct snd_pcm_substream *substream,
                  struct snd_pcm_status64 *status)
{
    ...
    if (snd_pcm_running (substream)) {
        ...
        if (runtime->tstamp_mode == SNDRV_PCM_TSTAMP_ENABLE) {
            ...
            status->driver_tstamp_sec = runtime->driver_tstamp.tv_sec;
            status->driver_tstamp_nsec = runtime->driver_tstamp.tv_nsec;
            status->audio_tstamp_sec = runtime->status->audio_tstamp.tv_sec;
            status->audio_tstamp_nsec = runtime->status->audio_tstamp.tv_nsec;
...
static int
snd_pcm_status_user64 (struct snd_pcm_substream *substream,
                       struct snd_pcm_status64 __user * _status, bool ext)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_status64 status;
...
static int
snd_pcm_status_user32 (struct snd_pcm_substream *substream,
                       struct snd_pcm_status32 __user * _status, bool ext)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_channel_info (struct snd_pcm_substream *substream,
...
static int
snd_pcm_channel_info_user (struct snd_pcm_substream *substream,
...
static void
snd_pcm_trigger_tstamp (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
 ...
 */
static int
snd_pcm_action_group (const struct action_ops *ops,
 ...
 */
static int
snd_pcm_action_single (const struct action_ops *ops,
                       struct snd_pcm_substream *substream,
                       snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
...
static void
snd_pcm_group_assign (struct snd_pcm_substream *substream,
 ...
 */
static void
snd_pcm_group_unref (struct snd_pcm_group *group,
                     struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_pcm_action (const struct action_ops *ops,
                struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_group *group;
 ...
 */
static int
snd_pcm_action_lock_irq (const struct action_ops *ops,
                         struct snd_pcm_substream *substream,
                         snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
 ...
 */
static int
snd_pcm_action_nonatomic (const struct action_ops *ops,
                          struct snd_pcm_substream *substream,
                          snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
 ...
 */
static int
snd_pcm_pre_start (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
...
static int
snd_pcm_do_start (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    int err;
...
static void
snd_pcm_undo_start (struct snd_pcm_substream *substream,
                    snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
snd_pcm_post_start (struct snd_pcm_substream *substream,
                    snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
int
snd_pcm_start (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_start_lock_irq (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_pcm_pre_stop (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
...
static int
snd_pcm_do_stop (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    if (substream->runtime->trigger_master == substream &&
...
static void
snd_pcm_post_stop (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
 ...
 */
int
snd_pcm_stop (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
int
snd_pcm_drain_done (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
int
snd_pcm_stop_xrun (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_pre_pause (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
...
static int
snd_pcm_do_pause (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    if (substream->runtime->trigger_master != substream)
...
static void
snd_pcm_undo_pause (struct snd_pcm_substream *substream,
                    snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
snd_pcm_post_pause (struct snd_pcm_substream *substream,
                    snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_pcm_pause (struct snd_pcm_substream *substream, bool push)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_pause_lock_irq (struct snd_pcm_substream *substream, bool push)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_pre_suspend (struct snd_pcm_substream *substream,
                     snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_do_suspend (struct snd_pcm_substream *substream,
                    snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
snd_pcm_post_suspend (struct snd_pcm_substream *substream,
                      snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_pre_resume (struct snd_pcm_substream *substream,
                    snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_do_resume (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
...
static void
snd_pcm_undo_resume (struct snd_pcm_substream *substream,
                     snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
snd_pcm_post_resume (struct snd_pcm_substream *substream,
                     snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_resume (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_pcm_xrun (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
...
static int
snd_pcm_pre_reset (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
...
static int
snd_pcm_do_reset (struct snd_pcm_substream *substream, snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
...
static void
snd_pcm_post_reset (struct snd_pcm_substream *substream,
                    snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_reset (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_pre_prepare (struct snd_pcm_substream *substream,
                     snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_do_prepare (struct snd_pcm_substream *substream,
                    snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
snd_pcm_post_prepare (struct snd_pcm_substream *substream,
                      snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_pcm_prepare (struct snd_pcm_substream *substream, struct file *file)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    int f_flags;
...
static int
snd_pcm_pre_drain_init (struct snd_pcm_substream *substream,
                        snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_do_drain_init (struct snd_pcm_substream *substream,
                       snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    ...
    if (runtime->state == SNDRV_PCM_STATE_DRAINING &&
        ...
        return substream->ops->trigger (substream, SNDRV_PCM_TRIGGER_DRAIN);

    return 0;
}

static void
snd_pcm_post_drain_init (struct snd_pcm_substream *substream,
                         snd_pcm_state_t state)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_pcm_drain (struct snd_pcm_substream *substream, struct file *file)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static int
snd_pcm_drop (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime;
 ...
 */
static int
snd_pcm_link (struct snd_pcm_substream *substream, int fd)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static void
relink_to_local (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_unlink (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_group *group;
 ...
 */
static int
snd_pcm_hw_rule_mul (struct snd_pcm_hw_params *params,
...
static int
snd_pcm_hw_rule_div (struct snd_pcm_hw_params *params,
                     struct snd_pcm_hw_rule *rule)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_hw_rule_muldivk (struct snd_pcm_hw_params *params,
                         struct snd_pcm_hw_rule *rule)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_hw_rule_mulkdiv (struct snd_pcm_hw_params *params,
                         struct snd_pcm_hw_rule *rule)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_hw_rule_format (struct snd_pcm_hw_params *params,
                        struct snd_pcm_hw_rule *rule)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_hw_rule_sample_bits (struct snd_pcm_hw_params *params,
                             struct snd_pcm_hw_rule *rule)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    ...
    pcm_for_each_format (k) {
        ...
        if (!snd_mask_test_format
            (hw_param_mask (params, SNDRV_PCM_HW_PARAM_FORMAT), k))
            continue;
        bits = snd_pcm_format_physical_width (k);
        if (bits <= 0)
            continue;           /* ignore invalid formats */
...
static int
snd_pcm_hw_rule_rate (struct snd_pcm_hw_params *params,
                      struct snd_pcm_hw_rule *rule)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_hw_rule_buffer_bytes_max (struct snd_pcm_hw_params *params,
                                  struct snd_pcm_hw_rule *rule)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_hw_rule_subformats (struct snd_pcm_hw_params *params,
                            struct snd_pcm_hw_rule *rule)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_hw_constraint_subformats (struct snd_pcm_runtime *runtime,
...
static int
snd_pcm_hw_constraints_init (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
    ...
    snd_interval_setinteger (constrs_interval
                             (constrs, SNDRV_PCM_HW_PARAM_CHANNELS));
    snd_interval_setinteger (constrs_interval
                             (constrs, SNDRV_PCM_HW_PARAM_BUFFER_SIZE));
    snd_interval_setinteger (constrs_interval
                             (constrs, SNDRV_PCM_HW_PARAM_BUFFER_BYTES));
    snd_interval_setinteger (constrs_interval
                             (constrs, SNDRV_PCM_HW_PARAM_SAMPLE_BITS));
    snd_interval_setinteger (constrs_interval
                             (constrs, SNDRV_PCM_HW_PARAM_FRAME_BITS));
...
static int
snd_pcm_hw_constraints_complete (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
...
static void
pcm_release_private (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    if (snd_pcm_stream_linked (substream))
...
int
snd_pcm_open_substream (struct snd_pcm *pcm, int stream,
                        struct file *file,
...
static int
snd_pcm_open_file (struct file *file, struct snd_pcm *pcm, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_file *pcm_file;
...
static int
snd_pcm_playback_open (struct inode *inode, struct file *file)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm *pcm;
...
static int
snd_pcm_capture_open (struct inode *inode, struct file *file)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm *pcm;
...
static int
snd_pcm_open (struct file *file, struct snd_pcm *pcm, int stream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    int err;
...
static int
snd_pcm_release (struct inode *inode, struct file *file)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm *pcm;
 ...
 */
static int
do_pcm_hwsync (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    switch (substream->runtime->state) {
...
forward_appl_ptr (struct snd_pcm_substream *substream,
                  snd_pcm_uframes_t frames, snd_pcm_sframes_t avail)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
...
static snd_pcm_sframes_t
rewind_appl_ptr (struct snd_pcm_substream *substream,
                 snd_pcm_uframes_t frames, snd_pcm_sframes_t avail)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static snd_pcm_sframes_t
snd_pcm_rewind (struct snd_pcm_substream *substream, snd_pcm_uframes_t frames)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static snd_pcm_sframes_t
snd_pcm_forward (struct snd_pcm_substream *substream,
                 snd_pcm_uframes_t frames)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_delay (struct snd_pcm_substream *substream, snd_pcm_sframes_t * delay)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    int err;
...
static inline int
snd_pcm_hwsync (struct snd_pcm_substream *substream)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_sync_ptr (struct snd_pcm_substream *substream,
                  struct snd_pcm_sync_ptr __user * _sync_ptr)
{
    ...
    if (get_user (sync_ptr.flags, (unsigned __user *) &(_sync_ptr->flags)))
        return -EFAULT;
    if (copy_from_user
        (&sync_ptr.c.control, &(_sync_ptr->c.control),
...
recalculate_boundary (struct snd_pcm_runtime *runtime)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_tstamp (struct snd_pcm_substream *substream, int __user * _arg)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_runtime *runtime = substream->runtime;
...
static int
snd_pcm_xferi_frames_ioctl (struct snd_pcm_substream *substream,
...
static int
snd_pcm_xfern_frames_ioctl (struct snd_pcm_substream *substream,
...
static int
snd_pcm_rewind_ioctl (struct snd_pcm_substream *substream,
...
static int
snd_pcm_forward_ioctl (struct snd_pcm_substream *substream,
                       snd_pcm_uframes_t __user * _frames)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_common_ioctl (struct file *file,
                      struct snd_pcm_substream *substream,
 ...
 */
int
snd_pcm_kernel_ioctl (struct snd_pcm_substream *substream,
...
static ssize_t
snd_pcm_read (struct file *file, char __user * buf, size_t count,
              loff_t * offset)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static ssize_t
snd_pcm_write (struct file *file, const char __user * buf,
...
static ssize_t
snd_pcm_readv (struct kiocb *iocb, struct iov_iter *to)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_file *pcm_file;
...
static ssize_t
snd_pcm_writev (struct kiocb *iocb, struct iov_iter *from)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_file *pcm_file;
...
static __poll_t
snd_pcm_poll (struct file *file, poll_table * wait)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_file *pcm_file;
 ...
 */
static vm_fault_t
snd_pcm_mmap_status_fault (struct vm_fault *vmf)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_mmap_status (struct snd_pcm_substream *substream, struct file *file,
 ...
 */
static vm_fault_t
snd_pcm_mmap_control_fault (struct vm_fault *vmf)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_substream *substream = vmf->vma->vm_private_data;
...
static int
snd_pcm_mmap_control (struct snd_pcm_substream *substream, struct file *file,
                      struct vm_area_struct *area)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static bool
pcm_status_mmap_allowed (struct snd_pcm_file *pcm_file)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static bool
pcm_control_mmap_allowed (struct snd_pcm_file *pcm_file)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
static vm_fault_t
snd_pcm_mmap_data_fault (struct vm_fault *vmf)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_substream *substream = vmf->vma->vm_private_data;
 ...
 */
int
snd_pcm_lib_mmap_iomem (struct snd_pcm_substream *substream,
                        struct vm_area_struct *area)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
 ...
 */
int
snd_pcm_mmap_data (struct snd_pcm_substream *substream, struct file *file,
                   struct vm_area_struct *area)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
...
static int
snd_pcm_mmap (struct file *file, struct vm_area_struct *area)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_file *pcm_file;
...
static int
snd_pcm_fasync (int fd, struct file *file, int on)
{
    printk(KERN_INFO "%s:%s(): reached here\n", __FILE__, __func__);
    ; /* avoid -Wswitch-unreachable */
    struct snd_pcm_file *pcm_file;
...
snd_pcm_get_unmapped_area (struct file *file,
                           unsigned long addr,
                           unsigned long len,
